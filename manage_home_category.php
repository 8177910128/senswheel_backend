...
$page_title="Manage Home Category";
...
if(isset($_POST['user_search']))
{
	...
	$user_qry="SELECT * FROM tbl_home WHERE tbl_home.`home_title` LIKE '%$searchInput%' OR tbl_home.`home_title` LIKE '%$searchInput%' ORDER BY tbl_home.`id` DESC";  
...
else
{
	...
	$tableName="tbl_home";		
	$targetpage = "manage_home_category.php"; 	
	$limit = 15; 
	...
	$users_qry="SELECT * FROM tbl_home
	ORDER BY tbl_home.`id` DESC LIMIT $start, $limit";  
...
<div class="row">
			...
			<div class="page_title_block">
				...
				<div class="col-md-7 col-xs-12">              
					<div class="search_list">
						...
						<div class="add_btn_primary"> <a href="add_home_category.php?add">Add   &nbsp;<i class="fa fa-plus-circle"></i></a> </div>
					</div>
				</div>
							...
							if(mysqli_num_rows($users_result) > 0)
							{
								while($users_row=mysqli_fetch_array($users_result))
								{
									...
									<tr>
										...
										<td><?php echo $users_row['home_title'];?></td>
										<td><?php echo $users_row['sequence'];?></td>
										<td>
										...
										<td class="text-center">
											<a href="add_home_category.php?cat_id=<?php echo $users_row['id'];?>&redirect=<?=$redirectUrl?>" class="btn btn-warning btn_edit" style="backgroung:linear-gradient(91.59deg, rgb(148, 63, 213) 1.37%, rgb(97, 43, 173) 98.71%);" data-toogle="tooltip" data-tooltip="Edit">
	...
	<script type="text/javascript">
		...
		$(".btn_delete").click(function(e){
			...
			swal({
				title: "Are you sure?",
				text: "All data will be deleted of this Category.",
				type: "warning",
