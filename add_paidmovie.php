<?php 
  if(isset($_GET['movie_id'])){ 
    $page_title= 'Edit Paid Movies';
  }
  else{ 
    $page_title='Add Paid Movies'; 
  }
  $current_page="paidmovies";
  $active_page="paidmovies";
  ...
  $genre_result=mysqli_query($mysqli,$genre_qry); 
	...
	{	
     ...
     $home_cat_id=$_POST['home_cat_id'];
      ...
      header( "Location:manage_paidmovies.php");
      exit;
	}
    ...
    <div class="card">
      <div class="page_title_block">
        ...
        <div class="col-md-7 col-xs-12" style="text-align:right;">
           <a href="manage_paidmovies.php" style="background:white;margin-top:10px;font-size:25px;">X</a>
        </div>
      </div>
