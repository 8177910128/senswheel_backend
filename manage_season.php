      ...
      <div class="page_title_block">
        ...
        <div class="col-md-7 col-xs-12">              
          <div class="search_list">
            ...
            <div class="add_btn_primary"> <a href="add_season.php?add=yes">Add Season &nbsp;<i class="fa fa-plus-circle"></i></a> </div>
          </div>
        </div>
      </div>
        ...
        <table class="table table-striped table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr>
               ...
               <td><a href="edit_season.php?id=<?php echo $row['id'];?>&redirect=<?=$redirectUrl?>" class="btn btn-primary btn_edit" style="backgroung:linear-gradient(91.59deg, rgb(148, 63, 213) 1.37%, rgb(97, 43, 173) 98.71%);" data-tooltip="Edit"><i class="fa fa-edit"></i></a>
