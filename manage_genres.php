      ...
      <div class="page_title_block">
        ...
        <div class="col-md-7 col-xs-12">
          <div class="search_list">
            ...
            <div class="add_btn_primary"> <a href="add_genre.php?add=yes">Add Genre &nbsp;<i class="fa fa-plus-circle"></i></a> </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-lg-3 col-sm-6 col-xs-12">
            <div class="block_wallpaper add_wall_category" style="border-radius: 10px;box-shadow: 0px 2px 5px #999">           
              <div class="wall_image_title">
                <h2><a href="manage_movies.php?genre=<?=$row['gid']?>" style=""><?php echo $row['genre_name'];?> <br><span><?php echo get_total_item($row['gid']);?></span></a></h2>
                <ul>    
                 <li class="btn btn-info" style="background:#EFF4F8;width:74px;border-radius:4px;"><a href="" style="color:#898889;" data-id="<?php echo $row['gid'];?>" class="btn_delete_a" data-toggle="tooltip" data-tooltip="Delete">Delete <i class="fa fa-trash" style="color:#898889;"></i></a></li>
                  <li class="btn btn-info" style="background:linear-gradient(91.59deg, rgb(148, 63, 213) 1.37%, rgb(97, 43, 173) 98.71%);width:74px;border-radius:4px;"><a href="add_genre.php?g_id=<?php echo $row['gid'];?>&redirect=<?=$redirectUrl?>" data-toggle="tooltip" data-tooltip="Edit"> Edit <i class="fa fa-edit"></i></a></li>               
                  
                </ul>
              </div>
              <span><img src="<?php echo $row['genre_image'];?>" style="height: 250px !important;"/></span>
            </div>
          </div>
      <?php
        $i++;
