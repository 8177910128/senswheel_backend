<?php 
  ...
  { 
    ...
    if($_FILES['movie_poster']['error']!=4){
      ...
      $tpath2='images/movies/'.$movie_poster; 
      copy($pic1,$tpath2);
    ...
    <div class="card">
      <div class="page_title_block">
        ...
        <div class="col-md-7 col-xs-12" style="text-align:right;">
           <a href="manage_movies.php" style="background:white;margin-top:10px;font-size:25px;">X</a>
        </div>
      </div>
                ...
                <div class="col-md-8">
                  <input type="file" name="trailer_local" value="" class="form-control trailer_local">
                    <?php 
                     ...
                     ?> 
                      <div style="word-break: break-all;"><label class="control-label">Current URL :-</label><?php echo $file_path.$row['trailer_url']?></div><br>
                      <?php  
                    }
                    ?>
                ...
                <div class="col-md-8">
                  <input type="file" name="video_local" value="" class="form-control video_local">
                    <?php 
                      if(isset($_GET['movie_id']) && $row['is_quality']=='false'){
                     ?> 
                      <div style="word-break: break-all;"><label class="control-label">Current URL :-</label><?php echo $file_path.$row['movie_url']?></div><br>
                      <?php  
                    }
                    ?>
