<?php 
  ...
  if(isset($_POST['search']))
  {
      ...
      $sql="SELECT * FROM tbl_shows WHERE (tbl_shows.`Shows_name` LIKE '%$search_txt%') ORDER BY tbl_shows.`id` DESC";
  ...
  else
  {
   ...
   $qry="SELECT * FROM tbl_shows ORDER BY tbl_shows.`id` DESC LIMIT $start, $limit";
      ...
      <div class="page_title_block">
        ...
        <div class="col-md-7 col-xs-12">
          <div class="search_list">
            ...
            <div class="add_btn_primary"> <a href="add_tv_shows.php?add=yes">Add Shows &nbsp;<i class="fa fa-plus-circle"></i></a> </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-lg-3 col-sm-6 col-xs-12">
            <div class="block_wallpaper"> 
              <div class="wall_category_block">
                ...
                <?php }else{?>
                    <a class="toggle_btn_a" style="background:rgba(239, 244, 248, 0.30);color:white;"  data-id="<?=$row['id']?>" data-action="active" data-column="is_slider" data-toggle="tooltip" data-tooltip="Set Slider" style="margin-left: 5px"><i class="fa fa-sliders"></i>
                    </a>
                <?php }?>
              ...
              <div class="wall_image_title" style="background-color:rgba(0, 0, 0, 0.4);">
                ...
                <ul> 
                  <li><a href="javascript:void(0)" data-toggle="tooltip"  style="background:gray;width:22px;border-radius:4px;padding20px;" data-tooltip="<?php echo $row['total_views'];?> Views"><i class="fa fa-eye" style="color:white;"></i></a></li>
                  ...
                  <li>
                    <a href="javascript:void(0)" style="background:gray;width:22px;border-radius:4px;padding20px;"   data-title="<?php if(strlen($row['Shows_name']) > 25){ echo substr(stripslashes($row['Shows_name']), 0, 25).'...';}else{ echo $row['Shows_name'];} ?>" class="btn_show_rate" data-toggle="tooltip" data-tooltip="View Rates"><i class="fa fa-star" style="color:white;"></i></a>
                        ...
                        <div class="list-group lg-alt lg-even-black">
                          <table width="100%">
                            ...
                            <tr>
                              ...
                              <td width="30px" align="center"><?=thousandsNumberFormat(getPostRating($row['id'],'5','Shows'))?></td>
                            ...
                            <tr>
                              ...
                              <td width="30px" align="center"><?=thousandsNumberFormat(getPostRating($row['id'],'4','Shows'))?></td>
                              <td align="left" style="padding:10px"><span style="display:block;height:15px;background-color:#ea1f62;width:0%"></span></td>
                            </tr>
                            <tr>
                              ...
                              <td width="30px" align="center"><?=thousandsNumberFormat(getPostRating($row['id'],'3','Shows'))?></td>
                              <td align="left" style="padding:10px"><span style="display:block;height:15px;background-color:#ea1f62;width:0%"></span></td>
                            </tr>
                            <tr>
                              ...
                              <td width="30px" align="center"><?=thousandsNumberFormat(getPostRating($row['id'],'2','Shows'))?></td>
                              <td align="left" style="padding:10px"><span style="display:block;height:15px;background-color:#ea1f62;width:0%"></span></td>
                            </tr>
                            <tr>
                              ...
                              <td width="30px" align="center"><?=thousandsNumberFormat(getPostRating($row['id'],'1','Shows'))?></td>
                              <td align="left" style="padding:10px"><span style="display:block;height:15px;background-color:#ea1f62;width:0%"></span></td>
                            </tr>
                            </tbody>
                          </table>
                 ...
                 <li><a href=""  style="background:gray;width:74px;border-radius:4px;padding20px;" data-id="<?php echo $row['id'];?>" class="btn_delete_a" data-toggle="tooltip" data-tooltip="Delete"> Delete <i class="fa fa-trash"></i></a></li>
                  <li><a href="add_tv_shows.php?shows_id=<?php echo $row['id'];?>&redirect=<?=$redirectUrl?>" style="background:linear-gradient(91.59deg, rgb(148, 63, 213) 1.37%, rgb(97, 43, 173) 98.71%);;width:74px;border-radius:4px;" data-toggle="tooltip" data-tooltip="Edit">Edit <i class="fa fa-edit"></i></a></li>               
              ...
              <span><img src="<?php echo $row['shows_cover'];?>" /></span>
            </div>
          </div>
      <?php
...
<script type="text/javascript">
  ...
  $(".btn_delete_a").click(function(e){
    ...
    swal({
        title: "Are you sure?",
        text: "Do you really want to delete this Shows.",
        type: "warning",
