<?php 
  ...
  if(isset($_GET['language']))
  {
      ...
      if(isset($_GET['language'])){
        $query = "SELECT COUNT(*) as num FROM $tableName WHERE tbl_events.`language_id`='$lang_id' ";

        $targetpage = "manage_events.php?language=$lang_id"; 
      }
      else{
        $query = "SELECT COUNT(*) as num FROM $tableName WHERE tbl_events.`language_id`='$lang_id'";
      ...
      $sql="SELECT tbl_language.`language_name`,tbl_events.* FROM tbl_events
          LEFT JOIN tbl_language ON tbl_events.`language_id`= tbl_language.`id` 
          WHERE tbl_events.`language_id`='$lang_id' 
  ...
  else if(isset($_POST["search"]))
  {
    ...
    $sql="SELECT tbl_language.`language_name`,tbl_events.* FROM tbl_events
          LEFT JOIN tbl_language ON tbl_events.`language_id`= tbl_language.`id` 
          WHERE (tbl_events.`event_title` LIKE '%$search_txt%' OR tbl_language.`language_name` LIKE '%$search_txt%') 
          ORDER BY tbl_events.`id` DESC";
      ...
      <div class="page_title_block">
        ...
        <div class="col-md-7 col-xs-12">              
          <div class="search_list">
            ...
            <div class="add_btn_primary"> <a href="add_event.php?add=yes">Add Event &nbsp;<i class="fa fa-plus-circle"></i></a> </div>
          </div>
        </div>
          ...
          <div class="col-lg-3 col-sm-6 col-xs-12" style="border-radius:20px;">
            <div class="block_wallpaper" style"width:251px;height:315px;flex-shrink: 0;border-radius:550px;">
              <div class="wall_category_block" style="border-radius:0px;">
                <h2 style="width: 260px;"><?php echo $row['event_title'];?></h2>  
              ...
              <div class="wall_image_title" style="background: rgba(0,0,0,0.0);border-radius:20px;">
               ...
               <ul>
                   ...
                   <li>
                    <a href="javascript:void(0)" style="background:rgba(239, 244, 248, 0.30);backdrop-filter: blur(2px);width:22px;border-radius:4px;" data-title="<?php if(strlen($row['event_title']) > 25){ echo substr(stripslashes($row['event_title']), 0, 25).'...';}else{ echo $row['event_title'];} ?>" class="btn_show_rate" data-toggle="tooltip" data-tooltip="View Rates"><i class="fa fa-star"></i></a>
                        ...
                        <div class="list-group lg-alt lg-even-black">
                          <table width="100%">
                            ...
                            <tr>
                              ...
                              <td width="30px" align="center"><?=thousandsNumberFormat(getPostRating($row['id'],'5','event'))?></td>
                            ...
                            <tr>
                              ...
                              <td width="30px" align="center"><?=thousandsNumberFormat(getPostRating($row['id'],'4','event'))?></td>
                              <td align="left" style="padding:10px"><span style="display:block;height:15px;background-color:#ea1f62;width:0%"></span></td>
                            </tr>
                            <tr>
                              ...
                              <td width="30px" align="center"><?=thousandsNumberFormat(getPostRating($row['id'],'3','event'))?></td>
                              <td align="left" style="padding:10px"><span style="display:block;height:15px;background-color:#ea1f62;width:0%"></span></td>
                            </tr>
                            <tr>
                              ...
                              <td width="30px" align="center"><?=thousandsNumberFormat(getPostRating($row['id'],'2','event'))?></td>
                              <td align="left" style="padding:10px"><span style="display:block;height:15px;background-color:#ea1f62;width:0%"></span></td>
                            </tr>
                            <tr>
                              ...
                              <td width="30px" align="center"><?=thousandsNumberFormat(getPostRating($row['id'],'1','event'))?></td>
                              <td align="left" style="padding:10px"><span style="display:block;height:15px;background-color:#ea1f62;width:0%"></span></td>
                            </tr>
                            </tbody>
                          </table>
                  ...
                  <li><a href="add_event.php?event_id=<?php echo $row['id'];?>&redirect=<?=$redirectUrl?>"  style="background:linear-gradient(91.59deg, rgb(148, 63, 213) 1.37%, rgb(97, 43, 173) 98.71%);width:74px;border-radius:4px;" data-toggle="tooltip" data-tooltip="Edit"> Edit <i class="fa fa-edit"></i></a></li>
                  <?php if($row['status']!="0"){?>
              ...
              <span style="border-radius:20px;"><img src="<?php echo $row['event_cover'];?>" /></span>
            </div>
            <div></div>
          </div>
          <?php
...
<script type="text/javascript">
  ...
  $(".btn_delete_a").click(function(e){
      ...
      swal({
          title: "Are you sure?",
          text: "All data will be deleted of this event.",
          type: "warning",
