<?php 
  if(isset($_GET['movie_id'])){ 
    $page_title= 'Edit Shortfilm';
  }
  else{ 
    $page_title='Add Shortfilm'; 
  }
  $current_page="shortfilms";
  $active_page="shortfilms";
  ...
  $genre_result=mysqli_query($mysqli,$genre_qry); 
	...
	{	
      ...
      $qry = Insert('tbl_shortfilms',$data);      
      ...
      header( "Location:manage_shortfilms.php");
      exit;
	}

  if(isset($_GET['movie_id']))
  {  
    $qry="SELECT * FROM tbl_shortfilms where id='".$_GET['movie_id']."'";
    $result=mysqli_query($mysqli,$qry);
  ...
  { 
    ...
    $edit=Update('tbl_shortfilms', $data, "WHERE id = '".$_GET['movie_id']."'");
    ...
    <div class="card">
      <div class="page_title_block">
        ...
        <div class="col-md-7 col-xs-12" style="text-align:right;">
           <a href="manage_shortfilms.php" style="background:white;margin-top:10px;font-size:25px;">X</a>
        </div>
      </div>
